...
import { getAllUsuarios, getUsuarioById, createUsuario, updateUsuario, deleteUsuario, loginUser, registerUser, getMe, updateMe, getPeluqueros } from "../controller/users.controller.js";
...
router.get("/usuarios/peluqueros", verifyToken, getPeluqueros);
